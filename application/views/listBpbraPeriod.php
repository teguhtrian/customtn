	...
	<div class="col-lg-12">
		<div class="panel panel-default">
	        <div class="panel-heading">
	            <i class="fa fa-th-list fa-fw"></i> BPBRA (<strong> <?php echo $period; ?> </strong>)
	        </div>
	        <!-- /.panel-heading -->
                    	...
                    	<?php
                        	...
                        	foreach ($bpbra as $b) {
                        		echo '<tr>
                            		...
                            		<td>'.$b->alamat.'</td>
                            		<td>'.$b->item.'</td>
                            		<td><form action="http://10.61.0.201:8080/bpbra/cetak/cetakBonUlang/'.$b->no_kwitansi.'" method="post" accept-charset="utf-8" id="myform" target="_blank"><button type="submit" class="btn btn-success"><i class="fa fa-print fa-fw"></i> Cetak</button></form></td>
                            	</tr>';
                            	$no++;
                        	}
                    	?>
