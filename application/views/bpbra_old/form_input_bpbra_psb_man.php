								...
								<div class="col-lg-6" style="border-style: solid;border: 10px">
									...
									<table width="100%">
										<tr>
											...
											<td>
												<textarea class="form-control" rows="1" name="ket" id="ket" placeholder="NPA: 00021xxxxx"></textarea>
											</td>
										</tr>
									</table>
								</div>
								<div class="col-lg-6" style="background-color: gray">
									...
									<table class="table" style="color: white; font-size: 10px; font-weight: bold" id="tableSaya">
										...
										<tbody>
											...
											<tr id="tr">
												<td colspan="3" style="font-size: 15px"><strong style="font-size: 12px">**Bebas PPN</strong></td>
											</tr>
											<!-- <tr id="tr">
