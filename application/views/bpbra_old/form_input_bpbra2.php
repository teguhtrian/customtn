...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                        	<?php echo form_open('home/inputBPBRA')?>
	                            ...
	                            <div class="row">
	                            	...
	                            	<div class="col-lg-3">
	                            		<div class="form-group">
	                            			<label>NPA</label>
	                            			<input class="form-control" type="text" name="npa_pel" value="" id="npa_pel" readonly="readonly">
	                            		</div>
	                            	</div>
	                            	<!-- /.col-lg-2 -->
	                            	<div class="col-lg-3">
	                            		<div class="form-group">
	                            			...
	                            			<input class="form-control" type="text" name="na_ctm" id="na_ctm" readonly="readonly">
	                            		</div>
	                            	</div>
	                            	<!-- /.col-lg-2 -->
	                            	<div class="col-lg-3">
	                            ...
	                            <div class="row">
	                            	<div class="col-lg-6">
	                            		<div class="form-group">
		                            		...
		                            		<textarea class="form-control" rows="2" name="alamat" id="alamat" readonly="readonly"></textarea>
	                            		</div>
	                            	</div>
	                            	<!-- /.col-lg-7 -->
	                            	<div class="col-lg-4">
	                            		<div class="form-group">
		                            		...
		                            		<input class="form-control" type="text" name="no_rmh" id="no_rmh" readonly="readonly">
	                            		</div>
	                            	</div>
	                            	<!-- /.col-lg-3 -->
	                            </div>
    ...
    <script>
	    ...
	    $(document).ready(function() {
		    ...
		    <?php 
			    foreach ($biaya as $b) {
			    	// echo'$(\'#tb-'.$b->id.'\').change(function() {
			    	// 	alert($(\'#tb-'.$b->id.'\').val());
				    //     if(this.checked) {
				    //         var returnVal = confirm("Menambahkan '.$b->itemnya.'?");
				    //         $(\'#tableSaya > tbody:last-child\').append(\'<tr><td>'.$b->rubrik.'</td><td>'.$b->itemnya.'</td><td>'.$b->biaya.'</td></tr><tr><td>50.06.50.00</td><td>PPN 10 % '.$b->itemnya.'</td><td>'.$b->biaya*0.01.'</td></tr>\');
				    //     }
				    ...
				    echo '$(\'#tb-'.$b->id.'\').click(function(){
			            if($(this).prop("checked") == true){
				            ...
				            $(\'#insertFrom\').after(\'<tr id="tb-'.$b->id.'"><td>'.$b->rubrik.'</td><td>'.$b->itemnya.'</td><td>'.$fmt->formatCurrency($b->biaya,"IDR").'</td><td id="biaya" hidden>'.$b->biaya.'</td></tr><tr id="tb-'.$b->id.'"><td>50.06.50.00</td><td>PPN 10 % '.$b->itemnya.'</td><td>'.$fmt->formatCurrency($b->biaya*0.1,"IDR").'</td><td id="ppn" hidden>'.$b->biaya*0.1.'</td></tr>\');
				            	jumlah();
			                }else{
