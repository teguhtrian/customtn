...
<body>
	<div id="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Menu Input BPBRA Pasang Baru</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<b>Data BPBRA Pasang Baru</b>
					</div>
					<div class="panel-body">
						<?php echo form_open('home/inputBPBRAPsb') ?>
						...
						<div class="row">
							...
							<div class="col-lg-3">
								<div class="form-group">
									<label>Nomor Register</label>
									<input class="form-control" type="text" name="noreg_pel" value="" id="noreg_pel" readonly="readonly">
								</div>
							</div>
							<!-- /.col-lg-2 -->
							<div class="col-lg-3">
